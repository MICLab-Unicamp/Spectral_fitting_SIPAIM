...
class TransientMaker:
    ...
    def add_random_amplitude_noise(self, noise_level_base=10, noise_level_scan_var=3):
        ...
        """
        base_noise = np.abs(noise_level_base * np.ones(self.fids.shape[0]) + np.random.uniform(low=-noise_level_scan_var,
